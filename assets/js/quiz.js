// Steven Spilberg Quiz questions
const quizSteven = [
    {
      question:
  ...
  // Alfred Hitchcock Quiz questions
  const quizAlfred = [
    {
      id: "0",
  ...
  // Director buttons
  const stevenBtn = document.querySelector("#btn-director-ss");
  const timBtn = document.querySelector("#btn-director-tb");
  const alfredBtn = document.querySelector("#btn-director-ah");
  ...
  let whichDir = event.target.value;
